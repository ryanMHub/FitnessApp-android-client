package com.ryanmhub.fitnessapp.android_client.common
...
suspend fun saveEncryptedData(dataStore: DataStore<Preferences>, key: String, data: String){
...
fun getEncryptedData(dataStore: DataStore<Preferences>, key: String) : Flow<String?> {
